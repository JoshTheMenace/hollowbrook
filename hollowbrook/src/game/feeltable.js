...
export const FEEL = Object.freeze({
  ...
  'wave-cleared':      { sfx: 'wave-clear', sfxOpts: { vol: 1.0 }, shake: 0.2, hitstop: 0.075, burst: { count: 18, color: '#ffd9a0', color2: '#dcb75a', speed: 2.0, up: 3.0, ttl: 0.9, size: 0.44 }, text: (d) => `${d.name ?? 'the wave'} — held`, textOpts: { color: '#ffd9a0', rise: 70, ttl: 1.6 } },   // size 0.44: out-renders a lance multikill (rendered ladder)
