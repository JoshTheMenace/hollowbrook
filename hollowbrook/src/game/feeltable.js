...
export const FEEL = Object.freeze({
  ...
  'kill-cutpurse':     { sfx: 'kill-light', sfxOpts: { vol: 0.7 }, burst: { count: 8, color: '#b8482e', color2: '#f2d6a8', speed: 2.0, up: 1.6, ttl: 0.45 }, text: () => 'cutpurse down', textOpts: { color: '#f2d6a8' } },
  'player-hurt':       { sfx: 'hurt', sfxOpts: (d) => ({ vol: 0.5 + Math.min(0.4, (d.damage ?? 12) / 60) }), shake: 0.35, burst: { count: 6, color: '#b8482e', color2: '#6c2a1e', speed: 1.0, up: 0.4, ttl: 0.3 } },
  'kill-hexer':        { sfx: 'kill-hexer', sfxOpts: { vol: 0.8 }, shake: 0.1, burst: { count: 8, color: '#62ead8', color2: '#b8482e', speed: 2.2, up: 2.0, ttl: 0.5 }, text: () => 'hexer down', textOpts: { color: '#9ef0e4' } },
  'kill-reaver':       { sfx: 'kill-heavy', sfxOpts: { vol: 0.8 }, shake: 0.1, hitstop: 0.0075, burst: { count: 10, color: '#b8482e', color2: '#f2d6a8', speed: 2.4, up: 1.8, ttl: 0.5 }, text: () => 'reaver down', textOpts: { color: '#f2d6a8' } },
  'kill-shieldbearer': { sfx: 'kill-heavy', sfxOpts: { vol: 0.9, rate: 0.85 }, shake: 0.2, hitstop: 0.0325, burst: { count: 14, color: '#b8482e', color2: '#dcb75a', speed: 2.6, up: 2.0, ttl: 0.55 }, text: () => 'shieldbearer down', textOpts: { color: '#f2d6a8' } },
  'lance-multikill':   { sfx: 'multikill', sfxOpts: { vol: 1.0 }, shake: 0.25, hitstop: 0.06, burst: { count: 16, color: '#ffb877', color2: '#b8482e', speed: 3.0, up: 2.4, ttl: 0.6 }, text: (d) => `${d.count} in one lance`, textOpts: { color: '#ffd9a0', rise: 60, ttl: 1.2 } },
  'wave-cleared':      { sfx: 'wave-clear', sfxOpts: { vol: 1.0 }, shake: 0.2, hitstop: 0.075, burst: { count: 18, color: '#ffd9a0', color2: '#dcb75a', speed: 2.0, up: 3.0, ttl: 0.9 }, text: (d) => `${d.name ?? 'the wave'} — held`, textOpts: { color: '#ffd9a0', rise: 70, ttl: 1.6 } },
  'kill-captain':      { sfx: 'kill-captain', sfxOpts: { vol: 1.0 }, shake: 0.5, hitstop: 0.14, burst: { count: 40, color: '#b8482e', color2: '#ffd9a0', speed: 3.4, up: 3.0, ttl: 1.0 }, text: () => 'THE CAPTAIN FALLS', textOpts: { color: '#ffb877', rise: 80, ttl: 2.0 } },
  'bell-rung':         { sfx: 'bell', sfxOpts: { vol: 1.0 }, shake: 0.6, hitstop: 0.2, burst: { count: 60, color: '#ffd9a0', color2: '#dcb75a', speed: 3.0, up: 4.0, ttl: 1.4 }, text: () => 'DAWN — Hollowbrook stands', textOpts: { color: '#ffd9a0', rise: 90, ttl: 3.0 } },
  // -- also declared
  ...
  'objective-done':    { sfx: 'objective-done', sfxOpts: { vol: 0.8 }, burst: { count: 12, color: '#ffd9a0', color2: '#f2d6a8', speed: 1.4, up: 2.4, ttl: 0.7 }, text: () => 'done', textOpts: { color: '#ffd9a0' } },
  'npc-sheltered':     { sfx: 'door', sfxOpts: { vol: 0.4 }, text: (d) => `${d.name} is safe`, textOpts: { color: '#f2ecdf' } },
  'barricade-up':      { sfx: 'barricade', sfxOpts: { vol: 0.7 }, burst: { count: 8, color: '#a39b8c', color2: '#625948', speed: 1.4, up: 1.2, ttl: 0.5 }, text: (d) => `barricade ${d.count}/${d.total}`, textOpts: { color: '#f2ecdf' } },
  'brazier-lit':       { sfx: 'brazier', sfxOpts: { vol: 0.7 }, burst: { count: 10, color: '#ffb877', color2: '#e3823f', speed: 1.0, up: 2.6, ttl: 0.8 }, text: (d) => `brazier ${d.count}/${d.total}`, textOpts: { color: '#ffb877' } },
  ...
  'captain-dash':      { sfx: 'captain-dash', sfxOpts: { vol: 0.7 }, burst: { count: 6, color: '#b8482e', color2: '#463f4f', speed: 1.6, up: 0.3, ttl: 0.35 } },
  // -- the rest of the run
  ...
  'lance-hit':         { sfx: 'lance-hit', sfxOpts: { vol: 0.7 }, burst: { count: 6, color: '#ffb877', color2: '#b8482e', speed: 2.0, up: 1.2, ttl: 0.35 } },
  'hexbolt-hit':       { sfx: 'hex-hit', sfxOpts: { vol: 0.6 }, burst: { count: 6, color: '#62ead8', color2: '#3cb8a8', speed: 1.4, up: 1.0, ttl: 0.4 } },
